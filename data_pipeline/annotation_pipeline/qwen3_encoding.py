# Vendored from omegalax/omegalax/data/qwen3_encoding.py so the pipeline has
# no omegalax dependency. This is the exact code the training chunk indexer
# uses, so token/bucket boundaries match training.
