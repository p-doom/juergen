...
with the legacy-equivalent idle knobs first::
    ...
    uv run python pipeline/stage_03_filter.py \
    ...
    uv run python pipeline/verify_against_legacy.py \
...
from pipeline.lib.common import normalize_dashed_argv, read_jsonl  # noqa: E402
from pipeline.lib.events import apply_label_policy, load_events  # noqa: E402
from pipeline.lib.views import FilterArtifact, build_segment_view  # noqa: E402
