...
from evals.micro_evals import cua_micro_eval as micro
...
from evals.micro_evals.cua_micro_eval import _call_model
from evals.micro_evals.osworld_system_prompts import SYSTEM_PROMPTS
from evals.micro_evals.sampling import qwen_sampling

# The suite ships beside the harness, not beside its tests.
_SUITE = Path(__file__).resolve().parents[1] / "cua_micro_tasks.json"
...
class ActionAndAggregationTests(unittest.TestCase):
    ...
    @mock.patch("evals.micro_evals.cua_micro_eval.requests.post")
